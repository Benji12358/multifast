...
module following_FFTW3
    use, intrinsic :: iso_c_binding
         include 'fftw3.f03'
end module


module following_fourier_in_xz_plane_seq
    use following_data
    implicit none
...
end module following_fourier_in_xz_plane_seq


module following_fourier_in_xz_plane
    use following_data
    implicit none
...
contains
    ...
    subroutine real_to_spectral(Fxz_z, Fxz_hat_x, sp_decomp)
        ...
        real*8, dimension(zstart_f(1):zend_f(1), zstart_f(2):zend_f(2), zstart_f(3):zend_f(3))      :: Fxz_z
...
end module following_fourier_in_xz_plane


module following_poisson_020_solver
...
contains
    ...
    subroutine prepare_lapY_matrix
        ...
        use following_common_workspace_view, only: lapY_file => following_common_lapY_file
    ...
    contains
        ...
        end subroutine perform_lapY_O2

    end subroutine prepare_lapY_matrix
    ...
    subroutine init
        ...
        ! assume O2 scheme is used for use of IBM in main channel
        kl = 1
        ku = 1
    ...
    contains
        ...
        end subroutine perform_K2eq_for_ik
    ...
    subroutine solve_Poisson(qcap_z, dph_z)
        ...
        !$ use OMP_LIB
        use following_fourier_in_xz_plane
        use following_mesh, only : n1,n2,n3, n1m,n2m,n3m
...
end module following_poisson_020_solver
