module fringe_data
    ...
    integer, parameter   :: POISEUILLE_INFLOW=0, SQUARE_INFLOW=1, INFLOW_FROM_FILE=2

    logical                                   :: use_fringe=.false.
    real*8                                    :: max_strength_damping, delta_rise, delta_fall
    integer                                   :: n_fringe_start, n_fringe_end, n_delta_fringe
    integer                                   :: inflow_buff, inflow_type
    integer                                   :: n_delta_rise, n_delta_fall
