...
module embedded_FFTW3
    use, intrinsic :: iso_c_binding
         include 'fftw3.f03'
end module


module embedded_fourier_in_xz_plane_seq
    use embedded_data
    implicit none
...
end module embedded_fourier_in_xz_plane_seq


module embedded_fourier_in_xz_plane
    use embedded_data
    implicit none
...
contains
    ...
    subroutine real_to_spectral(Fxz_z, Fxz_hat_x, sp_decomp)
        ...
        real*8, dimension(zstart_e(1):zend_e(1), zstart_e(2):zend_e(2), zstart_e(3):zend_e(3))      :: Fxz_z
...
end module embedded_fourier_in_xz_plane


module embedded_poisson_020_solver
...
contains
    ...
    subroutine prepare_lapY_matrix
        ...
        use embedded_common_workspace_view, only: lapY_file => embedded_common_lapY_file
    ...
    subroutine solve_Poisson(qcap_z, dph_z)
        ...
        !$ use OMP_LIB
        use embedded_fourier_in_xz_plane
        use embedded_mesh, only : n1,n2,n3, n1m,n2m,n3m
...
end module embedded_poisson_020_solver
