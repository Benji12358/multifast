...
module embedded_arctan_transfo
    implicit none
    real*8      :: beta
...
end module embedded_arctan_transfo


module embedded_lamballais_transfo
...
end module embedded_lamballais_transfo

module embedded_mesh_interface
    use embedded_lamballais_transfo
    use embedded_arctan_transfo
...
end module embedded_mesh_interface

module embedded_mesh_loader

    use embedded_mesh_interface
    use embedded_lamballais_transfo
    use embedded_arctan_transfo
    use embedded_mesh
...
end module embedded_mesh_loader

module embedded_mesh_generator
...
contains
    ...
    subroutine generate_mesh(n1, n2, n3, L1, L2, L3, str)
        ...
        if (nrank==0) then
            ...
            mesh_generator_path='Log/Mesh_generator/embedded/'

            mesh_generator_path=trim(log_path)//"Mesh_generator/"
            mesh_generator_path_y=trim(mesh_generator_path)//"embedded/"
...
end module embedded_mesh_generator
