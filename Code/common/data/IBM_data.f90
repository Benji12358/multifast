module IBM_data
    ...
    ! real*8, dimension(:,:,:), allocatable   :: IBM_mask2_y, IBM_mask3_y, IBM_mask3_z
    ! real*8, dimension(:,:,:), allocatable   :: IBM_mask_bounds1_x, IBM_mask_bounds2_x, IBM_mask_bounds3_x, IBM_mask_boundscc_x, IBM_mask_boundscc_y, IBM_mask_boundscc_z

    real*8, dimension(:,:,:), allocatable   :: mask_objects_q1_x, mask_objects_q2_x, mask_objects_q3_x, mask_objects_sca_x
    real*8, dimension(:,:,:), allocatable   :: mask_kim_q1_x, mask_kim_q2_x, mask_kim_q3_x, mask_kim_sca_x
    ...
    real*8, dimension(:,:,:), allocatable   :: mask_fadlun_sca_y


    real*8, dimension(:,:,:), allocatable   :: interpol_coef_q1, interpol_coef_q2, interpol_coef_q3, interpol_coef_sca
