...
!        pr_x=0.d0
        ...
        if (flow_type==CONSTANT_FLOW) then
            ...
            if (streamwise==1) call perform_boundary_layer_1(ts1, Y(5)) ! BLASIUS BOUNDARY LAYER ON 4 NODES 
            if (streamwise==3) call perform_boundary_layer_3(ts3, Y(5)) ! BLASIUS BOUNDARY LAYER ON 4 NODES 
        end if
